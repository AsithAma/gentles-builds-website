  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-6 -right-6 bg-construction-500 text-white p-6 rounded-lg shadow-lg hidden md:block">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6 leading-tight">Premium Construction Services Since 2009</h2>
      ...
      <section className="py-20 px-4 md:px-8 bg-gray-50">
        <div className="container mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">High-Quality Construction Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ServiceCard
              image="https://images.unsplash.com/photo-1604748308951-5d8fad4e5205?q=80&w=800&auto=format&fit=crop&h=400&q=80"
            ...
            />
            <ServiceCard
              image="https://images.unsplash.com/photo-1613545325278-f24b0cae1224?q=80&w=800&auto=format&fit=crop&h=400&q=80"
            ...
            />
            <ServiceCard
              image="https://images.unsplash.com/photo-1575517111839-3a3843ee7f5d?q=80&w=800&auto=format&fit=crop&h=400&q=80"
              title="New Builds"
            ...
            />
            <ServiceCard
              image="https://images.unsplash.com/photo-1557429287-b2e26467fc2b?q=80&w=800&auto=format&fit=crop&h=400&q=80"
            ...
            />
            <ServiceCard
              image="https://images.unsplash.com/photo-1581094794329-c8112a89af12?q=80&w=800&auto=format&fit=crop&h=400&q=80"
            ...
            />
            <ServiceCard
              image="https://images.unsplash.com/photo-1560185007-5f0bb1866cab?q=80&w=800&auto=format&fit=crop&h=400&q=80"
      ...
      <section className="py-24 px-4 md:px-8 bg-gradient-to-b from-construction-50 to-white">
        <div className="container mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">The Gentles Construction Difference</h2>
            <p className="text-gray-600">
              We stand apart from other construction companies with our commitment to quality, transparency, and customer satisfaction.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-construction-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-gray-600">
                Our team of fully qualified tradesmen guarantees a high standard of workmanship on every project we undertake.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-construction-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-gray-600">
                Contact Gentles Construction for a free no-obligation project consultation and detailed quote.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-construction-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-gray-600">
                We are fully insured up to £10 million of public liability, so you're always in safe hands with us.
              </p>
            </div>
          </div>
        </div>
      ...
      <CallToAction
        ...
        backgroundImage="https://images.unsplash.com/photo-1581094794329-c8112a89af12?q=80&w=1700&auto=format&fit=crop&h=700&q=80"
      />
    </Layout>
  );
};
